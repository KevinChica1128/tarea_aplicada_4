...
\hline 
\end{tabular} 
~\\La varianza del modelo $\sigma^2$, es mayor para el método PCR, donde $\sigma_{MCO}^{2}=6724487923$ y $\sigma_{PCR}^2=8549932422$, obviamente, la varianza de las estimaciones también van a ser más altas con los Betas obtenidos por PCR que con los Betas obtenidos por MCO, ya que para calcular dicha varianza, la formula es $V(\beta)=(X^{T}X)^{-1}\hat{\sigma^2}$ y $(X^{T}X)^{-1}$ es el mismo para ambos.
