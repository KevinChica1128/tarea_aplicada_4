...
~\\Los valores propios para la matriz $X^{T}X$ correspondiente a nuestros datos son:
~\\$\lambda_{1}=5899151649,\lambda_{2}=71014417,\lambda_{3}=22677581,\lambda_{4}=2338923,\lambda_{5}=617446.6,\lambda_{6}=66680.87,\lambda_{7}=953.785,\lambda_{8}=248.5233$
~\\De aquí, tenemos que $\lambda_{max}=5899151649$ y $\lambda_{min}=248.5233$, por lo tanto el número de condición es:
$$k=\frac{\lambda_{max}}{\lambda_{min}}=\frac{5899151649}{248.5233}=23736815.22$$
~\\El cuál es demasiado grande, lo que nos indica una multicolinealidad grave en nuestro modelo con todas las variables.
~\\Y los indices de condición son:
~\\$$k_{1}=\frac{5899151649}{5899151649}=1,k_{2}=\frac{5899151649}{71014417}=83.069775,k_{3}=\frac{5899151649}{22677581}=260.131433$$
~\\$$k_{4}=\frac{5899151649}{2338923}=2522.165821,k_{5}=\frac{5899151649}{617446.6}=9554.10824,k_{6}=\frac{5899151649}{66680.87}=88468.42654$$
~\\$$k_{7}=\frac{5899151649}{953.785}=6184991.008,k_{8}=\frac{5899151649}{248.5233}=23736815.22$$
~\\Podemos ver que 5 indices de condición son mayores que 1000 y 1 mas es mayor que 100, lo que nos dice que al menos hay 5 fuertes dependencias casi lineales en los datos de nuestro modelo (columnas de $X^{T}X$).
...
$$|X^{T}X|=|R|=0.000000404$$
~\\Por lo cual podemos re afirmar que hay una multicolinealidad grave en nuestro modelo.
\end{itemize}
